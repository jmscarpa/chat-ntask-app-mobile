...
import app.ntask.chat.newarchitecture.MainApplicationReactNativeHost;
import app.ntask.chat.networking.SSLPinningPackage;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("app.ntask.chat.ReactNativeFlipper");
        aClass
